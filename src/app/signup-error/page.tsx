...
export const metadata: Metadata = {
  title: "Signup Error Page | MSU Website",
  description: "This is Error Page for MSUNLI Website",
  // other metadata
};
        ...
        <div className="container">
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center p-8">
               <span className="flex justify-center items-center"><ExclamationTriangleIcon className="text-red-600"/></span>
                ...
                <Link
                  href="/signin"
                  className="px-8 py-2 text-base font-bold text-white duration-300 rounded-md bg-primary shadow-signUp hover:bg-white hover:text-primary md:px-9 lg:px-8 xl:px-9"
                >
                  Back to Sign In
                </Link>
              </div>
