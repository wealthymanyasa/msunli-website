...
export default function Home() {
  return (
    ...
    :className="{'b eh': darkMode === true}"
  >
     {/* ===== Header Start ===== */}
    <header
  className="g s r vd ya cj"
  :className="{ 'hh sm _k dj bl ll' : stickyMenu }"
...
>
  <div className="bb ze ki xn 2xl:ud-px-0 oo wf yf i">
    <div className="vd to/4 tc wf yf">
      ...
      <button className="po rc" @click="navigationOpen = !navigationOpen">
        <span className="rc i pf re pd">
          <span className="du-block h q vd yc">
            <span className="rc i r s eh um tg te rd eb ml jl dl" :className="{ 'ue el': !navigationOpen }"></span>
            <span className="rc i r s eh um tg te rd eb ml jl fl" :className="{ 'ue qr': !navigationOpen }"></span>
            <span className="rc i r s eh um tg te rd eb ml jl gl" :className="{ 'ue hl': !navigationOpen }"></span>
          </span>
          <span className="du-block h q vd yc lf">
            <span className="rc eh um tg ml jl el h na r ve yc" :className="{ 'sd dl': !navigationOpen }"></span>
            <span className="rc eh um tg ml jl qr h s pa vd rd" :className="{ 'sd rr': !navigationOpen }"></span>
          </span>
        </span>
      </button>
       {/* Hamburger Toggle BTN */}
    ...
    <div
      ...
      :className="{ 'd hh rm sr td ud qg ug jc yh': navigationOpen }"
    >
      <nav>
        <ul className="tc _o sf yo cg ep">
          <li><a href="index.html" className="xl" :className="{ 'mk': page === 'home' }">Home</a></li>
          ...
          <li className="c i" x-data="{ dropdown: false }">
            <a
              ...
              :className="{ 'mk': page === 'blog-grid' || page === 'blog-single' || page === 'signin' || page === 'signup' || page === '404' }"
            >
              Pages
             ...
             {/* Dropdown Start */}
            <ul className="a" :className="{ 'tc': dropdown }">
              <li><a href="blog-grid.html" className="xl" :className="{ 'mk': page === 'blog-grid' }">Blog Grid</a></li>
              <li><a href="blog-single.html" className="xl" :className="{ 'mk': page === 'blog-single' }">Blog Single</a></li>
              <li><a href="signin.html" className="xl" :className="{ 'mk': page === 'signin' }">Sign In</a></li>
              <li><a href="signup.html" className="xl" :className="{ 'mk': page === 'signup' }">Sign Up</a></li>
              <li><a href="404.html" className="xl" :className="{ 'mk': page === '404' }">404</a></li>
            </ul>
             {/* Dropdown End */}
          </li>
      ...
      <div className="tc wf ig pb no">
        <div className="pc h io pa ra" :className="navigationOpen ? '!-ud-visible' : 'd'">
          <label className="rc ab i">
            <input type="checkbox" :value="darkMode" @change="darkMode = !darkMode" className="pf vd yc uk h r za ab" />
             {/* Icon Sun */}
            <svg :className="{ 'wn' : page === 'home', 'xh' : page === 'home' && stickyMenu }" className="th om" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="signin.html" :className="{ 'nk yl' : page === 'home', 'ok' : page === 'home' && stickyMenu }" className="ek pk xl">Sign In</a>
        <a href="signup.html" :className="{ 'hh/[0.15]' : page === 'home', 'sh' : page === 'home' && stickyMenu }" className="lk gh dk rg tc wf xf _l gi hi">Sign Up</a>
      </div>
    </div>
  </div>
</header>
    ...
    <p className="bb on/5 wo/5 hq" x-text="sectionTitleText"></p>
       ...
       {/* ===== Pricing Table Start ===== */}
      <section x-data="setup()" className="i pg fh rm ji gp uq">
         {/* Bg Shapes */}
    ...
    <p className="bb on/5 wo/5 hq" x-text="sectionTitleText"></p>
        ...
        <div className="tc wf xf jb og">
          ...
          <button className="i rg gm" x-cloak @click="billPlan == 'monthly' ? billPlan = 'annually' : billPlan = 'monthly'">
            <div className="fe id bl gh rg xk outline-none"></div>
            <div
              className="h vc wf xf ge jd cl jl ml mf hh rg yk ea fa"
              :className="{ 'ff': billPlan == 'monthly', 'gf': billPlan == 'annually' }"
            ></div>
          </button>
          ...
          <div className="wc qf pn xo jg">
            <template x-for="(plan, i) in plans" x-key="i">
              ...
              <div className="animate_top rj sg hh sm vk xm hi nj oj">
                <h4 x-text="plan.name" className="wj kk wm fb"></h4>
                ...
                <div className="tc wf xf kg cc">
                  <h2
                    ...
                    className="fk _j kk wm"
                  ></h2>
                  <span x-text="billPlan == 'monthly' ? '/per month' : '/per year'" className="sc ak kk wm"></span>
                </div>
                ...
                <a
                  href="#"
                  className="ek rg lk ml il gi ri"
                  :className="plan.name == 'Growth Plan' ? 'gh sl' : 'mh tl'"
                >
                  Try for free
                </a>
    ...
    <p className="bb on/5 wo/5 hq" x-text="sectionTitleText"></p>
        ...
        <div className="bb ze ki xn 2xl:ud-px-0 jb" x-data="{filterTab: 1}">
          {/*  {/* Porject Tab */} 
          <div
            className="projects-tab _e bb tc uf wf xf cg rg hh rm vk xm si ti fc"
          >
            <button
              data-filter="*"
              @click="filterTab = 1"
              :className="{ 'gh lk' : filterTab === 1 }"
          ...
          <div className="projects-wrapper tc -ud-mx-5">
            ...
            <div className="project-item wi fb vd jn/2 to/3 branding ecommerce">
              <div className="c i pg sg z-1">
                ...
                <div 
                  className="h s r df nl kl im tc sf wf xf vd yc sg al hh/20 z-10"
                >
          ...
          <div className="wc qf pn xo zf iq">
            ...
            <div className="animate_top sg vk rm xm">
              <div className="c rc i z-1 pg">
                ...
                <div
                  className="im h r s df vd yc wg tc wf xf al hh/20 nl il z-10"
                >
            ...
            <div className="animate_top w-full mn/5 to/3 vk sg hh sm yh rq i pg">
              ...
              <div>
                ...
                <ul className="tc wf fg">
                  ...
                  <li>
                    <a href="#" className="c tc wf xf ie ld rg ml il tl">
                      <svg className="th lm ml il" width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                  ...
                  <li>
                    <a href="#" className="c tc wf xf ie ld rg ml il tl">
                      <svg className="th lm ml il" width="22" height="14" viewBox="0 0 22 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
              ...
              <form action="https://formbold.com/s/unique_form_id" method="POST">
                <div className="tc sf yo ap zf ep qb">
                  <div className="vd to/2">
                    <label className="rc ac" for="fullname">Full name</label>
                    <input
                      type="text"
                      name="fullname"
                      id="fullname"
                  ...
                  <div className="vd to/2">
                    <label className="rc ac" for="email">Email address</label>
                    <input
                      type="email"
                      name="email"
                      id="email"
                ...
                <div className="tc sf yo ap zf ep qb">
                  <div className="vd to/2">
                    <label className="rc ac" for="phone">Phone number</label>
                    <input
                      type="text"
                      name="phone"
                      id="phone"
                  ...
                  <div className="vd to/2">
                    <label className="rc ac" for="subject">Subject</label>
                    <input
                      type="text"
                      for="subject"
                      id="subject"
                ...
                <div className="fb">
                  <label className="rc ac" for="message">Message</label>
                  <textarea
                    placeholder="Message"
                    rows="4"
                    name="message"
